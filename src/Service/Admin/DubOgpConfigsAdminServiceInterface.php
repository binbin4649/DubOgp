...
interface DubOgpConfigsAdminServiceInterface extends \DubOgp\Service\DubOgpConfigsServiceInterface
{
     ...
     * @param \Cake\Datasource\Paging\PaginatorInterface $dubOgpConfigs
     * @return array
     */
    public function getViewVarsForIndex(\Cake\Datasource\Paging\PaginatorInterface $dubOgpConfigs): array;
