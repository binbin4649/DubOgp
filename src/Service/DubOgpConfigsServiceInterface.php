...
interface DubOgpConfigsServiceInterface
{
    ...
    /**
     * get
     * @return \DubOgp\Model\Entity\DubOgpConfig
     */
    public function get(): \DubOgp\Model\Entity\DubOgpConfig;
     ...
     * @return \Cake\Datasource\EntityInterface|null
     */
    public function update(array $postData): ?\Cake\Datasource\EntityInterface;
